		...
		<div class="top_head">
			...
			<div class="top_head_navigation">
				<ul class="top_head_navigation_ul">
					...
					<li class="top_head_navigation_li"><a href="#">关于我们</a></li>
					<li class="top_head_navigation_li"><a href="#">客房预订</a></li>
					<li class="top_head_navigation_li"><a href="#">产品介绍</a></li>
					<li class="top_head_navigation_li"><a href="#">交通位置</a></li>
				</ul>
			</div>
		</div>
